    ...
    <div class="col-12 mb-4">
        <div class="card bg-light text-dark h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4>Bus Ticket Booking System</h4>
                        <p>Add Location , Route, Date according to you</p>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="me-3">
                        ...
                        <div class="text-lg fw-bold">$0000</div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="me-3">
                        ...
                        <div class="text-lg fw-bold">$00000</div>
                    </div>
    ...
    <div class="col-lg-6 col-xl-3 mb-4">
        <div class="card bg-success text-white h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="me-3">
                        <div class="text-white-75 small">Loss or Profit</div>
                        <div class="text-lg fw-bold">$0000</div>
                    </div>
    ...
    <div class="col-lg-6 col-xl-3 mb-4">
        <div class="card bg-danger text-white h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="me-3">
                        <div class="text-white-75 small">Pending Money</div>
                        <div class="text-lg fw-bold">$0000</div>
                    </div>
